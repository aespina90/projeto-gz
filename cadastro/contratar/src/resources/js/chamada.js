    ...
    $.ajax({
        ...
        success: function (resposta) {
            ...
            if(resposta.mensagem == ["100"]) {
                window.location.assign("http://login.gzcloud.com.br/cadastro/sucesso.html");
            }else if(resposta.mensagem == ["208"]){
                window.location.assign("http://login.gzcloud.com.br/cadastro/possui_cadastro.html");
            }else if(resposta.mensagem == ["400"]){
                window.location.assign("http://login.gzcloud.com.br/cadastro/cnpj_cadastrado.html");
            }else if(resposta.mensagem == ["500"]){
                window.location.assign("http://login.gzcloud.com.br/cadastro/erro_gravacao.html");
            }else if(resposta.mensagem == ["600"]){
                window.location.assign("http://login.gzcloud.com.br/cadastro/clientegz.html");
            }
        },
