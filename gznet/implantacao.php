              ...
              <tr>
                <td width="775" align="center" valign="top"> <br>
                  <table width="90%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td class="texto_geral_titulo">
                         <img src="imagens/img_seta.jpg" />&nbsp; Implanta&ccedil;&atilde;o  </td>
                    </tr>
                    <tr>
                      <td valign="top">
                       <div class="texto_geral"><br>
                         <p>A GZ Sistemas oferece aos  clientes a experi&ecirc;ncia de nossa equipe que orienta desde o<br> 
                          momento da escolha  da solu&ccedil;&atilde;o mais adequada &agrave; sua empresa at&eacute; os processos de<br> 
                          implanta&ccedil;&atilde;o e  treinamento para utiliza&ccedil;&atilde;o dos produtos, para que se tenha garantia do<br> 
                          sucesso  do projeto.<br>
                          <br>
                         </p>
                         <p>Todo nosso trabalho &eacute; customizado  de acordo com a realidade de cada um dos clientes:<br> 
                          seu porte, cultura,  ambientes internos e externos, desempenho e objetivos.<br>
                          <br>
                         </p>
                         <p>Entre em contato com a equipe GZ  Sistemas:<br>
                           Tel.: (11) 3308-8199 / 4521-8199<br>
                           E-mail: <a href="mailto:vendas@gzsistemas.com.br">vendas@gzsistemas.com.br</a> </p>
                         <br>
                       </div>                      </td>
                    </table>
                </td>
