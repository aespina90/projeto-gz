                   ...
                   <td width="775" height="597" align="center" valign="top"> <br>
                     <table width="90%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                         ...
                         <div class="texto_geral_titulo"><?php echo $rs_dados['assunto'];?></div>
                       </tr>
                       <tr>
                         <td height="105"><br>
                           <div class="texto_geral"><br>
                             ...
                             if($rs_num_rows_imagem > 0) { ?>
                               ...
                               if($rs_dados['fontelink'] != '') { ?>
                                  <a href="<?php echo $rs_dados['fontelink'];?>" target="_blank"> <?php
                               } ?>

                               <img src="dbimagens/thumbnail/<?php echo $rs_imagem['arquivo'];?>" class="img_noticias">
                               <p align="left" style="padding-left:25px;font: bold 15px Tahoma;">
                                 <?php echo $rs_dados['lead'];?>
                               </p>
                             ...
                             <?php } ?>
                             <br>
                             <?php echo $rs_dados['materia'];?>
                             <br>

                             <?php
                             if($rs_num_rows_imagem1 > 0) { ?>
                               <a href="#" onClick="fnImagemPopUp( 'Noticia' , 800 , 600 , 'dbimagens/<?php echo $rs_imagem1['arquivo'];?>' , 'Tela' );">
                               <img src="dbimagens/thumbnail/<?php echo $rs_imagem1['arquivo'];?>" width="150" class="img_noticias">
                               <?php
                             } ?>
                             <?php
                             if($rs_num_rows_imagem2 > 0) { ?>
                               <a href="#" onClick="fnImagemPopUp( 'Noticia' , 800 , 600 , 'dbimagens/<?php echo $rs_imagem2['arquivo'];?>' , 'Tela' );">
                               <img src="dbimagens/thumbnail/<?php echo $rs_imagem2['arquivo'];?>" width="150" class="img_noticias">
                               <?php
                             } ?>
                             <?php
                             if($rs_num_rows_imagem3 > 0) { ?>
                               <a href="#" onClick="fnImagemPopUp( 'Noticia' , 800 , 600 , 'dbimagens/<?php echo $rs_imagem3['arquivo'];?>' , 'Tela' );">
                               <img src="dbimagens/thumbnail/<?php echo $rs_imagem3['arquivo'];?>" width="150" class="img_noticias">
                               <?php
                             } ?>
                             <?php
                             if($rs_num_rows_imagem4 > 0) { ?>
                               <a href="#" onClick="fnImagemPopUp( 'Noticia' , 800 , 600 , 'dbimagens/<?php echo $rs_imagem4['arquivo'];?>' , 'Tela' );">
                               <img src="dbimagens/thumbnail/<?php echo $rs_imagem4['arquivo'];?>" width="150" class="img_noticias">
                               <?php
                             } ?>
                             <?php
