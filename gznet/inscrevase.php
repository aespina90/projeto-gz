            ...
            <table width="775" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="775" height="586" align="center" valign="top"><br/>
                  <form name="inscrevase" id="inscrevase" action="inscrevase_obrigado.php?id=<?php echo $id;?>&amp;tipo=<?php echo $tipo;?>" method="post" onSubmit="return validaform_inscrevase(this)";>
                    <table width="470" border="0" cellspacing="0" cellpadding="0" class="interna">
                      ...
                      <tr>
                        ...
                        <td colspan="2"><p class="texto_geral"><?php echo $dados['nome'];?></p></td>
                      </tr>
                      <tr>
                        <td valign="top"><div align="right" class="texto_fomularios"><strong>Data/Horário:</strong></div></td>
                        <td colspan="2"><p class="texto_geral"><?php echo fun_tratamento_data($dados['datatreino'],'L');?></p></td>
                      </tr>
                      <tr>
