...
$default['registro'] = 'parceiro est&aacute; cadastrado no sistema.';
$default['campos'] = 'parceiros est&atilde;o cadastrados no sistema.';
$rs_teste = '';
$default['_campo2'] = 'descricao';
$default['_titcampo2'] = 'Descri&ccedil;&atilde;o';
require($template['valvars']);
$rs_sql = 'SELECT * FROM tbparceiros';
if($var_busca != ''){ $rs_busca = ' WHERE '.$default['busca'].' LIKE "%'.$var_busca.'%"'; }
...
<table width="760" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
	<tr><th colspan="10">Cadastro de <?php echo $default['titulo'];?></th></tr>
	<tr bgcolor="#EBEBEB">
      <td align="center">
      ...
      <td colspan="6" align="center">
		<a href="formcadastro.php?acao=I&amp;pagina=<?php echo $var_pagina;?>&amp;ordem=<?php echo str_replace(" ","%20",$var_ordem);?>&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>">Novo Parceiro</a>
	  </td>
	</tr>
    <tr bgcolor="#F7F7F7">
	  ...
	  <td width="120" align="center" bgcolor="#F7F7F7"><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=nome%20desc&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_decres.gif" alt="Ordenar de Z a A" border="0" align="right" /></a><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=nome&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_cres.gif" alt="Ordenar de A a Z" align="right" border="0" /></a><strong>Empresa</strong></td>
	  <td width="120" align="center" bgcolor="#F7F7F7"><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=url%20desc&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_decres.gif" alt="Ordenar de Z a A" border="0" align="right" /></a><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=url&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_cres.gif" alt="Ordenar de A a Z" align="right" border="0" /></a><strong>Site</strong></td>
	  <td width="120" align="center" bgcolor="#F7F7F7"><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=datacadastro%20desc&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_decres.gif" alt="Ordenar de Z a A" border="0" align="right" /></a><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=datacadastro&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_cres.gif" alt="Ordenar de A a Z" align="right" border="0" /></a><strong>Data Cadastro</strong></td>
	...
	if($rs_linhas > 0){
		for($cont_i=0; $cont_i<$rs_linhas; $cont_i++){
			...
			if(trim(strtoupper($rs_dados['status'])) == "A"){ $var_status = $folders['icones']."ico_ativo_on.gif"; $var_texto_status = 'Ativo'; }
			else{ $var_status = $folders['icones']."ico_ativo_off.gif"; $var_texto_status = 'Inativo'; }
	?>
    <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#ededed';" onMouseOut="this.bgColor='#ffffff';">
		...
		<td align="center"><?php echo $rs_dados['url'];?></td>
		<td align="center"><?php echo $var_datacadastro;?></td>
