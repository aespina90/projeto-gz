...
$default['registro'] = 'revenda est&aacute; cadastrada no sistema.';
$default['campos'] = 'revendas est&atilde;o cadastradas no sistema.';
$rs_teste = '';
$default['_campo2'] = 'nome_fantasia';
$default['_titcampo2'] = 'Nome Fantasia';
require($template['valvars']);
$rs_sql = 'SELECT * FROM tbrevendas';
if($var_busca != ''){
...
<table width="760" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
      ...
      <td colspan="3" align="center" bgcolor="#EBEBEB"><a href="index.php"><img src="<?php echo $folders['icones'];?>ico_lista.gif" alt="Listar todos os registros" title="Listar todos os registros" hspace="5" border="0" align="right" /></a>
        ...
        Buscar: <input name="busca" type="text" id="busca" value="<?php echo $var_busca;?>" size="24" maxlength="24" />
			<select name="seleciona_busca" id="seleciona_busca">
				<option value="nome" <?php ($default['busca'] == 'nome') ? print 'selected="selected"' : false;?>>Nome da Pessoa de Contato</option>
				<option value="nome_fantasia" <?php ($default['busca'] == 'nome_fantasia') ? print 'selected="selected"' : false;?>>Nome Fantasia da Revenda</option>
				<option value="cidade" <?php ($default['busca'] == 'cidade') ? print 'selected="selected"' : false;?>>Cidade</option>
			</select>
      </td>
      <td colspan="6" align="center">
		<a href="formcadastro.php?acao=I&amp;pagina=<?php echo $var_pagina;?>&amp;ordem=<?php echo str_replace(" ","%20",$var_ordem);?>&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>">Nova Revenda</a>
	  </td>
	</tr>
    <tr bgcolor="#F7F7F7">
		<td width="80" align="center"><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=id%20desc&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_decres.gif" alt="Ordenar de Z a A" border="0" align="right" /></a><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=id&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_cres.gif" alt="Ordenar de A a Z" align="right" border="0" /></a><strong>C&oacute;digo</strong></td>
		<td width="80" align="center" bgcolor="#F7F7F7"><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=cidade%20desc&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_decres.gif" alt="Ordenar de Z a A" border="0" align="right" /></a><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=cidade&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_cres.gif" alt="Ordenar de A a Z" align="right" border="0" /></a><strong>Cidade</strong></td>
		<td align="center" bgcolor="#F7F7F7"><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=nome%20desc&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_decres.gif" alt="Ordenar de Z a A" border="0" align="right" /></a><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=nome&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_cres.gif" alt="Ordenar de A a Z" align="right" border="0" /></a><strong>Nome de Contato</strong></td>
		<td width="140" align="center" bgcolor="#F7F7F7"><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=nome_fantasia%20desc&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_decres.gif" alt="Ordenar de Z a A" border="0" align="right" /></a><a href="?pagina=<?php echo $var_pagina;?>&amp;ordem=nome_fantasia&amp;busca=<?php echo $var_busca;?>&amp;itens=<?php echo $var_itens;?>"><img src="<?php echo $folders['icones'];?>ico_ordem_cres.gif" alt="Ordenar de A a Z" align="right" border="0" /></a><strong>Nome Fantasia</strong></td>
	...
	if($rs_linhas > 0){
		for($cont_i=0; $cont_i<$rs_linhas; $cont_i++){
			...
			$sql_estado = 'SELECT * FROM tbestados WHERE status = "A" AND id = "'.$rs_dados['estado'].'"';
			$query_estado = mysql_query($sql_estado,$conexao['conexao'])or die(mysql_error());
			$linhas_estado = mysql_num_rows($query_estado);
			if($linhas_estado > 0){ $dados_estado = mysql_fetch_array($query_estado); }
    ...
    <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#ededed';" onMouseOut="this.bgColor='#ffffff';">
		...
		<td align="center"><?php echo $rs_dados['cidade'].'/'.$dados_estado['sigla'];?></td>
		<td align="center"><?php echo $rs_dados['nome'];?></td>
		<td align="center"><?php echo $rs_dados['nome_fantasia'];?></td>
