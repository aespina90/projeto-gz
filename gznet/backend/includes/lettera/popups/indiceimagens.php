...
?>
    <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#ededed';" onMouseOut="this.bgColor='#ffffff';">
		...
		<td align="center" width="20"><a href="#"><img src="<?php print $folders['icones'] ; ?>ico_seta.gif" alt="Escolher este arquivo" title="Escolher este arquivo" border="0" onClick="window.opener.document.formCadastro.<?php print $var_campo ; ?>.value='<?php print $rs_dados['arquivo'] ; ?>';window.close();"></a></td>
    </tr>
<?php
		}
	}
