...
<html>
<head>
<title>Lettera | Inserir Link</title>
</head>
...
<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Inserir URL:</span>
<table width="280" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
 <tr>
  <td style="padding-bottom: 2px; width: 50px; font-family: arial, verdana, helvetica; font-size: 11px;">Tipo:</td>
...
<div align="right" style="padding-top: 5px;"><input type="submit" value="  Inserir URL  " onClick="insertHyperLink();" style="font-size: 12px;" >&nbsp;<input type="submit" value="  Cancelar  " onClick="window.close();" style="font-size: 12px;" ></div>
