...
<html>
<head>
<title>Lettera | Criar Tabela</title>
</head>
...
<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Propriedades da Tabela:</span>
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
 <tr>
  <td style="padding-bottom: 2px; width: 70px; font-family: arial, verdana, helvetica; font-size: 11px;">Linhas:</td>
  ...
  <td style="padding-bottom: 2px; width: 100px; font-family: arial, verdana, helvetica; font-size: 11px;">Largura da Tabela:
 ...
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Colunas:</td>
  ...
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Alinhamento:</td>
	<td style="padding-bottom: 2px; padding-top: 0px;">
	<select name="alignment" id="alignment" style="margin-right: 10px; font-size: 10px; width: 95px;">
 ...
 <tr>
  <td style="padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Enchimento:</td>
	<td style="padding-top: 0px;"><input type="text" size="4" id="padding" name="padding" value="5" style="font-size: 10px; width: 65px;"></td>
  <td style="padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Ocultar Borda:</td>
	<td style="padding-top: 0px;"><input type="checkbox" name="borderCollapse" id="borderCollapse"></td>
 </tr>
</table>

<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Propriedades da Borda:</span>
 ...
 <tr>
  <td>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="115">
	 <tr id="No Border"    ><td class="off" onClick="selectBorder('No Border');" onMouseOver="this.className = 'on'" onMouseOut="this.className = 'off'" style="font-family: arial, verdana, helvetica; font-size: 11px;">&nbsp;Sem borda&nbsp;</td></tr>
	 <tr id="No Border on" ><td class="on" style="font-family: arial, verdana, helvetica; font-size: 11px;">&nbsp;Sem Borda&nbsp;</td></tr>
	...
	<td style="font-family: arial, verdana, helvetica; font-size: 11px;" valign="top">
	 ...
	 <table border="0" cellpadding="0" cellspacing="0">
	  <tr>
	   ...
	   <td><button style="font-size: 10px; font-family: arial, verdana, helvetica, sans serif; margin-right: -8px; width: 50px;" onClick="showBorderColorMenu();">Escolher</button></td>
		</tr>
	 </table>
	 ...
	 <table border="0" cellpadding="0" cellspacing="0">
	  <tr>
	   ...
	   <td><button style="font-size: 10px; font-family: arial, verdana, helvetica, sans serif; margin-right: -8px; width: 50px;" onClick="showShadingColorMenu();">Escolher</button></td>
		</tr>
	 </table>
...
<div align="right"><input type="submit" value="  Inserir Tabela  " onClick="buildTable();" style="font-size: 12px;">&nbsp;<input type="submit" value="  Cancelar  " onClick="window.close();" style="font-size: 12px; margin-right: 15px;" ></div>
</body>
</html>
