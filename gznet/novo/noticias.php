        ...
        <tr>
          <td align="center" valign="top">
			...
			<tr>
                          <td height="105">
                            <br>
                            <div class="texto_geral_titulo"><a href="noticias_interno.php?id=<?=$rs_dados['id'];?>&id_secao=<?=$rs_dados['idsecao'];?>"><?=$rs_dados['assunto'];?></a></div>
                            <div class="texto_geral">
			      <br>
                              <?php
                              if ($rs_linhas > 0) { ?>
                                 <a href="noticias_interno.php?id=<?=$rs_dados['id'];?>&id_secao=<?=$rs_dados['idsecao'];?>"><img src="dbimagens/thumbnail/<?=$rs_imagem['arquivo'];?>" class="img_noticias"></a>       <?php
                              } ?>
                            </div>
                          </td>
                        </tr>
