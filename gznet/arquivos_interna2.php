                              ...
                              if($linhas_arquivo > 0) { ?>
                                ...
                                for($a=0; $a<$linhas_arquivo; $a++) {
                                   ...
                                   <tr bgcolor="#FFFFFF" class="texto_geral" type="text" onMouseOver="this.bgColor='#EDEDED';" onMouseOut="this.bgColor='#FFFFFF';">
                                     ...
                                     <td width="30%"><b><u><p onClick="fnDownFile(<?php echo $id;?>,<?php echo $dados_arquivo['id'];?>,'<?php echo $arquivo;?>');" style="cursor:pointer;"><?php echo $dados_arquivo['arquivo'];?></p></b></u></td>
