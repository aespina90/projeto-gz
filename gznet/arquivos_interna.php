                           ...
                           for($s=0; $s<$linhas_secao; $s++){
                              ...
                              if($linhas_arquivo > 0) { ?>
                                ...
                                for($a=0; $a<$linhas_arquivo; $a++) {
								   ...
								   $dados_arquivo['arquivo'] = strtr($dados_arquivo['arquivo'], "áàãâéêíóôõúüçÁÀÃÂÉÊÍÓÔÕÚÜÇ","aaaaeeiooouucAAAAEEIOOOUUCs");
//                                   $arquivo       = "/home/gzsistemas/www/gzsistemas.com.br/downloads/".$dados_secao['pasta']."/".$dados_arquivo['arquivo'];
                                   $arquivo       = "/home/gznet/www/downloads/".$dados_secao['pasta']."/".$dados_arquivo['arquivo'];
                                   $dnarquivo     = "http://www.gznet.com.br/downloads/".$dados_secao['pasta']."/".$dados_arquivo['arquivo'];
