                ...
                <td width="775" height="586" align="center" valign="top"> <br>
                  <table width="90%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <img src="imagens/img_seta.jpg"> Comunicação PDV x Retaguarda [FLEXBRIDGE]
                      </p></div><br/>
                    </tr>
                    <tr>
                      <td height="105" colspan="3" class="texto_geral"><br/>
                        <a href="#" onClick="fnImagemPopUp( 'GZ Sistemas - Telas' , 797 , 546 , 'imagens/tela_flexbridge.jpg' , 'Telas do Sistema' );">
                        <img src="imagens/tela_flexbridge.jpg" width="430" border="0" alt="Telas do Sistema"/></a></span>&nbsp;&nbsp;
                        <br/><br/>
                        <p>É um módulo novo do projeto Flex que faz a interligação entre o FlexPDV e MercoFlex/FlexConcent. Este módulo é responsável pelas atualizações de movimento de venda on-line, carga de dados para os pdv's, consultas on-line do pdv à retaguarda, entre outras transações.</p><br/>
                      </td>
                    </tr>
                  </table>
                </td>
