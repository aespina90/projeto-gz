          ...
          <td align="center" valign="top">
            ...
            <table width="775" border="0" cellspacing="0" cellpadding="0">
              <tr>
                        ...
                        if($linhas_usuario > 0) {       ?>
                           <table width="90%" border="0" cellspacing="0" cellpadding="0">
                             ...
                             for($u=0; $u<$linhas_usuario; $u++){
                                 ...
                                 <tr class="texto_geral">
                                   <td>&nbsp;&nbsp;&nbsp;</td>
                                   <td style="width:350px;"><?=$dados_usuario['nome'];?>&nbsp;</td>
                                   <td style="width:140px;" align="center"><?=fun_tratamento_data($dados_usuario['datatreino'],'L');?></td>
                                   <td style="width:80px;" align="center"><a href='javascript:MM_openBrWindow("conteudo_treinamento.php?id=<?=$dados_usuario['id'];?>&amp;tipo=U","Conteúdo","width=385,height=210,scrollbars=yes")'><u>Conteúdo</u></a></td>
                                   <td style="width:80px;" align="center"><a href="inscrevase.php?id=<?=$dados_usuario['id'];?>&amp;tipo=U"><u>Inscreva-se</u></a></td>
				 </tr>
				<?php
			      } ?>
                           </table><br/><br/>
			   ...
			   <tr class="texto_geral">
                             <td>&nbsp;&nbsp;&nbsp;</td>
                             <td style="width:350px;"><?=$dados_treinamento['nome'];?>&nbsp;</td>
                             <td style="width:140px;" align="center"><?=fun_tratamento_data($dados_treinamento['datatreino'],'L');?></td>
                             <td style="width:80px;" align="center"><a href='javascript:MM_openBrWindow("conteudo_treinamento.php?id=<?=$dados_treinamento['id'];?>&amp;tipo=R","Conteúdo","width=385,height=210,scrollbars=yes")'><u>Conteúdo</u></a></td>
                             <td style="width:80px;" align="center"><a href="inscrevase.php?id=<?=$dados_treinamento['id'];?>&amp;tipo=R"><u>Inscreva-se</u></a></td>
                           </tr>
                           <?php
                        } ?>
                      </table>
