                ...
                <td width="775" height="586" align="center" valign="top"> <br>
                  <table width="90%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <img src="imagens/img_seta.jpg"> Recarga de Celular
                      </p></div><br/>
                    </tr>
                    <tr>
                      <td height="105">
                        <div class="texto_geral">
                          <div align="right">
                            <a href="http://www.softwareexpress.com.br" target="_blank">
                            <img src="imagens/logo_express.jpg" border="0" alt="logo_express">
                            </a>
                          </div><br/>
                          <p>A solu&ccedil;&atilde;o Recarga de Celular permite que o estabelecimento ofere&ccedil;a ao cliente a comodidade de recarregar seu celular pr&eacute;-pago no caixa da loja (PDV). </p>
                          <br/>
                          <p> O GZ MercoSuper faz a integra&ccedil;&atilde;o com o software da Software Express, possibilitando o aumento do fluxo na loja em raz&atilde;o de oferecer mais um serviço ao cliente. </p><br/>
                          <br>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td height="105" colspan="2">&nbsp;</td>
                    </tr>
                  </table>
                </td>
              </tr>
