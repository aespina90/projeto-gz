        ...
        <div id="index">
            ...
            <div id="corpo">
                <div id="senhas_relatorio">
                    <form method="post" action="model_revista.php" enctype="multipart/form-data">
                        <div class="header_form"> Inserir Comunicado </div>
                        <div class="div_extra">
                        <input type="file" size="42"name="arquivo" /><br />
                        <input type="submit" value="Enviar" />
                        </div>
                    </form>
                </div>
                <div id="infos_revista">
                    asd
                </div>
