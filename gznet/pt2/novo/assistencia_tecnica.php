                ...
                <td width="775" height="586" align="center" valign="top"> <br>
                  <table width="90%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <img src="imagens/img_seta.jpg"> Assistência Técnica
                      </p></div><br/>
                    </tr>
                    <tr>
                      <td height="105">
                        <div class="texto_geral"><br>
                          <p> Nossa equipe de Assistência Técnica está em constante aperfeiçoamento para oferecer uma estrutura de suporte e manutenção capacitada a todos os produtos lançados no mercado, em todo território nacional.</p><br/>
			      &Aacute;gil, ela tem como proposta oferecer a mais eficiente solu&ccedil;&atilde;o para o problema no menor espa&ccedil;o de tempo poss&iacute;vel.
			  </p>
			 </div>
		      </td>
                    </tr>
