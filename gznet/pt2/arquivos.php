		...
		<td width="775" height="586" align="center" valign="top"> <br>
		    ...
		    <tr>
                        ...
                        <div class="texto_geral">
                          <p style="margin-top:10px;">Faça o seu cadastro enviando um email para <a href="mailto:novaversao@gznet.com.br">novaversao@gznet.com.br</a> e receba automaticamente o manual de alterações do sistema sempre que houver uma nova versão ou release.</p><br/>
                          <p><strong>ARQUIVOS E ATUALIZAÇÕES</strong></p>
                        </div>
			   ...
			   <?php
                           ...
                           for($cont_secao=1; $cont_secao<=$linhas_secao; $cont_secao++) {
                              ...
                              if($dados_secao['atualizando']!='S') {
                                ?>
                                <a href="arquivos_interna.php?secao=<?=$dados_secao['id']?>&obs=<?=$dados_secao['obs']?>&nome_secao=<?=$dados_secao['secao'];?>">
                                <u><?=$dados_secao['secao'];?></u></a><br/>
                                <?php
                              } else {
                                ?>
